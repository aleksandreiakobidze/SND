...
function remainingCapacity(stat: DriverLoadStats): { liters: number; kg: number; orders: number } {
  return {
...
export function UnassignedOrderCard({ orderId, order, driverStats, driverColors, onAssign }: Props) {
  ...
  const hasWarning = warning ? warning.liters || warning.kg || warning.orders : false;
        ...
        <div className="flex-1 space-y-1.5">
          ...
          >
            ...
            {driverStats.map((stat, idx) => {
              ...
              const isOver = over.liters || over.kg || over.orders;
              return (
